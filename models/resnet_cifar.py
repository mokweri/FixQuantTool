...
class ResNet(nn.Module):
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]], layers: List[int], num_classes: int = 10,
        ...
        # Modified conv1 for CIFAR-10 (3x3 kernel, stride 1)
        self.conv1 = nn.Conv2d(3, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = norm_layer(self.inplanes)
        self.relu = nn.ReLU(inplace=True)

        # Removed max-pooling for CIFAR-10
...
def resnet18_cifar10(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """ResNet-18 for CIFAR-10."""
    return _resnet(BasicBlock, [2, 2, 2, 2], **kwargs)


def resnet50_cifar10(*, progress: bool = True, **kwargs: Any) -> ResNet:
